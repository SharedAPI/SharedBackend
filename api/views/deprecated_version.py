...
from api.serializers.plugin import DeprecatedPluginVersionSerializer
    ...
    def put(self, request, plugin_version_id=None):
        ...
        if not deprecation.is_valid():
            return self.error_response(
                "Error during plugin deprecation serialization", deprecation.errors
            )
        ...
        return self.success_response(
            "Deprecation of Plugin Version is done", plugin_version, status.HTTP_200_OK
        )
